def get_initital_permutation_array():
    to_return =  [58, 50, 42, 34, 26, 18, 10,  2,
...
def get_inverse_permutation_array():
    to_return = [40, 8, 48, 16, 56, 24, 64, 32,
...
def get_expansion_permutation_array():
    to_return = [32, 1, 2, 3, 4, 5,
                 4, 5, 6, 7, 8, 9,
                 8, 9, 10, 11, 12, 13,
                 12, 13, 14, 15, 16, 17,
                 16, 17, 18, 19, 20, 21,
...
def get_pc_2_permutation():
    to_return = [14, 17, 11, 24, 1, 5, 3, 28, 15, 6, 21, 10,
                 23, 19, 12, 4, 26, 8, 16, 7, 27, 20, 13, 2,
                 41, 52, 31, 37, 47, 55, 30, 40, 51, 45, 33, 48,
                 44, 49, 39, 56, 34, 53, 46, 42, 50, 30, 29, 32] 
    to_return = map(lambda x: x-1, to_return)
    return to_return
